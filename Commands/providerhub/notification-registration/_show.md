# [Command] _providerhub notification-registration show_
...
- notification-registration show
    ```bash
        providerhub notification-registration show --name "{notificationRegistration}" --provider-namespace "{providerNamespace}"
    ```